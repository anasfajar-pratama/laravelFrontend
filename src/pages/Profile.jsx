                ...
                <div className="mt-2 flex gap-1">
                  ...
                  <span className="text-xs text-gray-400 ml-2">
                    {['', 'Lemah', 'Cukup', 'Kuat', 'Sangat Kuat'][
                      Math.min(4, (formPassword.password.length >= 6 ? 1 : 0) + (formPassword.password.length >= 8 ? 1 : 0) + (/[A-Z]/.test(formPassword.password) || /[0-9]/.test(formPassword.password) ? 1 : 0) + (/[^A-Za-z0-9]/.test(formPassword.password) ? 1 : 0))
                    ]}
                  </span>
                </div>
              )}
