              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input type="text" name="nama_barang" value={editForm.nama_barang || ''} onChange={handleEditChange} className="w-full border rounded-lg px-4 py-3" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium mb-1">Harga (Rp)</label>
                    <input type="number" name="harga" value={editForm.harga || ''} onChange={handleEditChange} className="w-full border rounded-lg px-4 py-3" />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="number" step="0.1" name="rating" value={editForm.rating || ''} onChange={handleEditChange} className="w-full border rounded-lg px-4 py-3" />
                  </div>
                </div>
              </div>
